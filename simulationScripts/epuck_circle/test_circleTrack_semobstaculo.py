...
for i in range(qnt_simulacoes):
    ...
    loadedScene = sim.loadScene('/home/kevin-lev/Área de Trabalho/Mestrado/projeto_e_anotacoes/BC_GAIL-CoppeliaSim_mobile_robots/simulationScenes/e_puck_trajetoria_circular_test_semobstaculo.ttt')

    if loadedScene != -1:
        print('Carregou cena e_puck_trajetoria_circular_test_semobstaculo.ttt!')
    else:
    ...
    if sys.argv[2] == '1':
        ...
        imitation_policy = bc.reconstruct_policy('/home/kevin-lev/Área de Trabalho/Mestrado/projeto_e_anotacoes/BC_GAIL-CoppeliaSim_mobile_robots/simulationData/BC/epuckCircletrack_semobstaculowithSensor/bc_policy.zip')
        fileDirectory = 'simulationData/epuckCircletrack_semobstaculo/withSensor/test/BC/' + today_date + '/epuck_circleTrack_' + str(i) + '.txt'
        fileDirectory_pos = 'simulationData/epuckCircletrack_semobstaculo/withSensor/test/BC/' + today_date + '/epuck_circle_positions_' + str(i) + '.txt'
    else:
        print('GAIL selecionada para as predições!')
        imitation_policy = PPO.load('/home/kevin-lev/Área de Trabalho/Mestrado/projeto_e_anotacoes/BC_GAIL-CoppeliaSim_mobile_robots/simulationData/GAIL/epuckCircletrack_semobstaculowithSensor/gail_policy.zip')
        fileDirectory = 'simulationData/epuckCircletrack_semobstaculo/withSensor/test/GAIL/' + today_date + '/epuck_circleTrack_' + str(i) + '.txt'
        fileDirectory_pos = 'simulationData/epuckCircletrack_semobstaculo/withSensor/test/GAIL/' + today_date + '/epuck_circle_positions_' + str(i) + '.txt'
