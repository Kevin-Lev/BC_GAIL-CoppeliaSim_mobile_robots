...
if imitation_method == '1':
    ...
    learner = sb3.PPO("MlpPolicy", vec_m_env, verbose=1, batch_size=56, n_steps=112, ent_coef=0.001, n_epochs=10, vf_coef=0.5)
    # learner = sb3.PPO("MlpPolicy", vec_m_env, verbose=1, batch_size=60, n_steps=120, ent_coef=0.001, n_epochs=10, vf_coef=0.5, policy_kwargs={"net_arch" : [nets_number, nets_number]})
